...
export default function LoginPage() {
  ...
  React.useEffect(() => {
    ...
    if (errorMsg) {
      setGlobalError(`Authentication failed: ${errorMsg}`);
      ...
      authAPI.getMe().then(user => {
        ...
        setGlobalError("Failed to fetch user profile after login.");
      });
    }
      ...
      >
        ...
        >
          ...
          <div className="my-6 flex items-center justify-between">
            ...
            <span className="text-[11px] font-medium uppercase text-white/30 tracking-widest">or continue with</span>
            <span className="w-1/5 border-b border-white/[0.08]"></span>
          </div>
