 ...
 * Gmail Logo
 */
export function GmailLogo({ size = 16, className }: LogoProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 * Google Tasks Logo
 */
export function GoogleTasksLogo({ size = 16, className }: LogoProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M10 16.5l-4-4 1.41-1.41L10 13.67l7.59-7.59L19 7.5l-9 9z" fill="#FFFFFF"/>
    </svg>
  );
}
